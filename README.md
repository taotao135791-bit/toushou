...
当前版本 v0.2.6，前往 [GitHub Release 页面](https://github.com/taotao135791-bit/toushou/releases/tag/v0.2.6) 下载：

| 平台 | 在线下载 | 大小 | SHA-256 |
| --- | --- | --- | --- |
| macOS（Apple Silicon） | [下载 DMG](https://github.com/taotao135791-bit/toushou/releases/download/v0.2.6/TouShou-arm64.dmg) | 见 Release | 见 Release |
| macOS（Intel） | [下载 DMG](https://github.com/taotao135791-bit/toushou/releases/download/v0.2.6/TouShou-x64.dmg) | 见 Release | 见 Release |
| Windows（x64） | [下载 EXE](https://github.com/taotao135791-bit/toushou/releases/download/v0.2.6/TouShou-x64.exe) | 见 Release | 见 Release |
